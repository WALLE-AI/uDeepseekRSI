...
interface SiderExpertsEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderExpertsEntry: React.FC<SiderExpertsEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  const label = t('experts.title', { defaultValue: 'Experts' });

  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={label} position='right'>
        <div
          data-testid='sider-experts-entry'
...
export default SiderExpertsEntry;
