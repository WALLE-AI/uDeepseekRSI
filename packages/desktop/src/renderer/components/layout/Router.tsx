...
const ExpertsPage = React.lazy(() => import('@renderer/pages/experts'));
    ...
    <HashRouter>
      ...
      <Routes>
        ...
        <Route element={<ProtectedLayout layout={layout} />}>
          ...
          {/* Expert library — a top-level entry like Assistants, not a settings page. */}
          <Route path='/experts' element={withRouteFallback(ExpertsPage)} />
          <Route path='/experts/:name' element={withRouteFallback(ExpertsPage)} />
