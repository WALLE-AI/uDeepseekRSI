            ...
            >
              ...
              >
                <div
                  ...
                  onClick={onClick}
                >
                  <img src={appLogo} alt='' className='absolute inset-0 size-full object-contain' />
                </div>
                {isSettingsRoute ? (
                  ...
                  <div className='text-16px text-t-primary collapsed-hidden font-semibold'>uworker</div>
                )}
                {isMobile && !collapsed && (
                  <button
                    type='button'
