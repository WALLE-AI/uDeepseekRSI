  ...
  const linkItems: LinkItem[] = [
    {
      ...
      url: 'https://github.com/WALLE-AI/uDeepseekRSI/wiki',
      icon: <Right theme='outline' size='16' className='rtl-mirror' />,
    },
    {
      title: t('settings.updateLog'),
      url: 'https://github.com/WALLE-AI/uDeepseekRSI/releases',
      icon: <Right theme='outline' size='16' className='rtl-mirror' />,
    },
    {
          ...
          <div className='flex flex-col items-center pb-24px'>
            ...
            <div className='flex items-center justify-center gap-8px mb-16px'>
              ...
              <div
                ...
                onClick={() =>
                  openLink('https://github.com/WALLE-AI/uDeepseekRSI').catch((error) =>
