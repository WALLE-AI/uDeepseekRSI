...
const ChannelModalContent: React.FC = () => {
  ...
  const channels: ChannelConfig[] = useMemo(() => {
    const telegramChannel: ChannelConfig = {
      ...
      description: t('settings.channels.telegramDesc', 'Chat with uworker assistant via Telegram'),
      status: 'active',
    ...
    const slackChannel: ChannelConfig = {
      ...
      description: t('settings.channels.slackDesc', 'Chat with uworker assistant via Slack'),
      status: 'active',
    ...
    const discordChannel: ChannelConfig = {
      ...
      description: t('settings.channels.discordDesc', 'Chat with uworker assistant via Discord'),
      status: 'active',
    ...
    const larkChannel: ChannelConfig = {
      ...
      description: t('settings.channels.larkDesc', 'Chat with uworker assistant via Lark or Feishu'),
      status: 'active',
    ...
    const dingtalkChannel: ChannelConfig = {
      ...
      description: t('settings.channels.dingtalkDesc', 'Chat with uworker assistant via DingTalk'),
      status: 'active',
    ...
    const weixinChannel: ChannelConfig = {
      ...
      description: t('settings.channels.weixinDesc', 'Chat with uworker assistant via WeChat'),
      status: 'active',
    ...
    const wecomChannel: ChannelConfig = {
      ...
      description: t('settings.channels.wecomDesc', 'Chat with uworker assistant via WeCom (Enterprise WeChat)'),
  ...
  const channelGuideText = t('settings.webui.featureChannelsDesc', {
    defaultValue: 'Connect Telegram, Lark, and DingTalk to interact with uworker from IM apps.',
  });
