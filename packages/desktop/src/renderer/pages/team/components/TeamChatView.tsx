...
const AionrsTeamChat: React.FC<{
  ...
  assistantAvatarIsEmoji?: boolean;
  assistantAvatarIsFallback?: boolean;
  ...
  assistant_name,
  assistantAvatar,
  assistantAvatarIsEmoji,
  assistantAvatarIsFallback,
  assistantBackend,
  teamSendMessage,
  teamRuntime,
  loadedSkills,
  ...
  return (
    <AionrsChat
      ...
      assistantAvatarIsEmoji={assistantAvatarIsEmoji}
      assistantAvatarIsFallback={assistantAvatarIsFallback}
...
const TeamChatView: React.FC<TeamChatViewProps> = ({
  ...
  const explicitAvatar = resolveAssistantAvatar(agent_icon);
  const assistantAvatar = presetAssistantInfo?.logo || (explicitAvatar.kind !== 'fallback' ? explicitAvatar.value : '');
  const assistantAvatarIsEmoji = presetAssistantInfo ? presetAssistantInfo.isEmoji : explicitAvatar.kind === 'emoji';
  const assistantAvatarIsFallback = presetAssistantInfo
    ? presetAssistantInfo.isFallback
    : explicitAvatar.kind === 'fallback';
      ...
      case 'aionrs':
        return (
          <AionrsTeamChat
            ...
            assistantAvatarIsEmoji={assistantAvatarIsEmoji}
            assistantAvatarIsFallback={assistantAvatarIsFallback}
            assistantBackend={resolvedAssistantBackend}
          />
        );
      default:
        return null;
