  ...
  return (
    <ChatLayout {...chatLayoutProps} conversation_id={conversation.id}>
      <AionrsChat
        ...
        assistantAvatar={presetAssistantInfo?.logo}
        assistantAvatarIsEmoji={presetAssistantInfo?.isEmoji}
        assistantAvatarIsFallback={presetAssistantInfo?.isFallback}
        assistantBackend={presetAssistantInfo?.backend}
