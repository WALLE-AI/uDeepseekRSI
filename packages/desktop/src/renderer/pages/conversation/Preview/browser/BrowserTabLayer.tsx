        ...
        return (
          ...
          >
            <BrowserViewer
              ...
              tabId={tab.id}
              active={isActive}
              browserControlRequestId={tab.metadata?.browserControlRequestId}
              browserControlState={tab.metadata?.browserControlState}
              browserControlRetryAt={tab.metadata?.browserControlRetryAt}
