...
describe('titleForPath', () => {
  ...
  it('uses the login title on the login route only', () => {
    ...
    expect(titleForPath('/guid', t)).toBe('uworker');
    expect(titleForPath('/conversation/abc', t)).toBe('uworker');
    expect(titleForPath('/settings/agent', t)).toBe('uworker');
  });
});

describe('DocumentTitle', () => {
  it('resets the title to uworker after leaving the login page', () => {
    ...
    expect(document.title).toBe('uworker');
  });
